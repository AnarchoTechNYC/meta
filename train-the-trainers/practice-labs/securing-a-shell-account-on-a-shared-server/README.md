...
> :computer::mortar_board: Not all such computer monitors glowed green. Notably, the technology of electrified plasma displays was popularized and commercialized by a pre-Internet network that is now largely forgotten called the [PLATO computer system]. PLATO was first available to student and faculty at the University of Illinois in 1960, and remained available until 2006, when the last PLATO system was shut down. This visionary Internet alternative was in fact the progenitor of many computing experiences we take for granted today, including forums, message boards, online learning and test taking, e-mail, chat rooms, instant messaging, remote screen sharing, and multiplayer video games. The early video monitors attached to the PLATO system glowed orange. Read *[The Friendly Orange Glow: The Untold Story of the PLATO System and the Dawn of Cyberculture](http://friendlyorangeglow.com/)* by Brian Dear for more information and history about PLATO. Visit a running PLATO system that has been connected to the Internet for posterity at [Cyber1.org](https://cyber1.org/).
