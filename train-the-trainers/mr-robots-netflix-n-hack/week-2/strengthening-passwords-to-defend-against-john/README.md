...
Although password cracking can get extremely complex, as you've seen, defending against this attack is extremely simple, and it's probably advice you've heard before: use a unique, long, randomly-generated password for each of your accounts. The challenge with this is that using such a password is difficult to remember, even moreso when you need to "remember" one for each of your accounts. That reality is this advice's Achilles heel. This catch-22 is what leads people to use easily-guessable passwords and, ultimately, what makes their passwords so crackable.

The simplest way to mitigate this may sound counter-intuitive: write your passwords down so you don't have to remember them. However, writing down simplistic passwords like "`g8password`" isn't any better than not writing the password down at all. On the other hand, if your password is something like "`,Fxi4nB3"*m1iAY.|{q}f\\o'-C50Gpx,JhYOd+Y#+3[.Qno|ujcKuo@+09(x8i`, then your account is pretty safe as long as you don't ever use this same password anywhere else. The problem with a password like that, of course, is that it takes several minutes to type it all out, which is a real pain. Worse, incorrectly type a single character and you've got to start over. Augh! :(
